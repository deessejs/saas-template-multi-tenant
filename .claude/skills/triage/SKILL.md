---
name: triage
description: Triage a GitHub issue — apply labels, post a structured review comment. Use when asked to triage, review, or label an issue.
---
...
- Does it have a `status:*` label? (template already sets `status:needs-triage`)
